...
"""Определения структур для взаимодействия с приборами Fastwel DIM763."""

from ctypes import Structure, c_uint8, c_uint16


class DIM763_CONFIGURATION(Structure):
...
class DIM763_INPUTS(Structure):
    """Область входных каналов "Inputs" модуля DIM763."""
...
class DIM763_OUTPUTS(Structure):
    """Область выходных каналов "Outputs" модуля DIM763."""
...
class DIM763(Structure):
    """Структура, представляющая модуль DIM763."""

    _pack_ = 1
    _fields_ = [
        ("Inputs", DIM763_INPUTS),                  # Область входных параметров Inputs модуля
        ("Outputs", DIM763_OUTPUTS),                # Область выходных параметров Outputs модуля
        ("Configuration", DIM763_CONFIGURATION),    # Область конфигурационных параметров модуля
    ]

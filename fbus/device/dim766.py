...
"""Определения структур для взаимодействия с приборами Fastwel DIM766."""

from ctypes import Structure, c_uint8, c_uint16
from enum import IntEnum


class DIM766_TYPE(IntEnum):
...
class DIM766_CONFIGURATION(Structure):
    """Область конфигурационных параметров модуля DIM766."""
...
class DIM766_INPUTS(Structure):
    """Область входных каналов "Inputs" модуля DIM766."""
...
class DIM766(Structure):
    """Структура, представляющая модуль DIM766."""

    _pack_ = 1
    _fields_ = [
        ("Inputs", DIM766_INPUTS),                  # Область входных параметров Inputs модуля
        ("Configuration", DIM766_CONFIGURATION),    # Область конфигурационных параметров модуля
    ]

...
"""Определения структур для взаимодействия с приборами Fastwel DIM719."""

from ctypes import Structure, c_uint8, c_uint16


class DIM719_CONFIGURATION(Structure):
...
class DIM719_INPUTS(Structure):
    """Область входных каналов "Inputs" модуля DIM719."""
...
class DIM719_OUTPUTS(Structure):
    """Область выходных каналов "Outputs" модуля DIM719."""
...
class DIM719(Structure):
    """Структура, представляющая модуль DIM719."""

    _pack_ = 1
    _fields_ = [
        ("Inputs", DIM719_INPUTS),                  # Область входных параметров Inputs модуля
        ("Outputs", DIM719_OUTPUTS),                # Область выходных параметров Outputs модуля
        ("Configuration", DIM719_CONFIGURATION),    # Область конфигурационных параметров модуля
    ]
